...
Source0:        http://www.kernel.org/pub/software/scm/git/%{pkg_name}-%{version}.tar.gz
Source2:        git-init.el
Source3:        git.xinetd.in
Source4:        git.conf.httpd
Source5:        git-gui.desktop
Source6:        gitweb.conf.in
Source10:       http://www.kernel.org/pub/software/scm/git/%{pkg_name}-manpages-%{version}.tar.gz
Source11:       http://www.kernel.org/pub/software/scm/git/%{pkg_name}-htmldocs-%{version}.tar.gz
Source12:       git.service
Source13:       git.socket
Source14:       git-remote-bzr
...
Provides:       %{?scl_prefix}git-core = %{version}-%{release}
...
Group:          Development/Tools
Requires:       %{?scl_prefix}git = %{version}-%{release}, subversion, perl(Term::ReadKey)
%description svn
...
GNU_ROFF = 1
htmldir = %{_docdir}/%{pkg_name}-%{version}
prefix = %{_prefix}
gitwebdir = %{_scl_root}%{_var}/www/git
EOF
...
%global __perl_requires %{_builddir}/%{pkg_name}-%{version}/%{pkg_name}-req
...
%endif
%global elispdir %{_scl_root}%{_emacs_sitelispdir}/git
...
exclude_re="archimport|email|git-citool|git-cvs|git-daemon|git-gui|git-remote-bzr|git-remote-hg|gitk|svn"
...
* Wed Jun 11 2014 Ondrej Oprala <ooprala@redhat.com> - 1.9.4-1
- git 1.9.4
- Use kernel.org for sources (googlecode's out-of-date)

* Mon May 26 2014 Ondrej Oprala <ooprala@redhat.com> - 1.9.3-3
- Fix a spec typo

* Fri May 16 2014 Ondrej Oprala <ooprala@redhat.com> - 1.9.3-2
- Re-add the hg and bzr subpackages for RHEL-7

* Fri May 16 2014 Ondrej Oprala <ooprala@redhat.com> - 1.9.3-1
- git 1.9.3

* Tue Jan 21 2014 Ondrej Oprala <ooprala@redhat.com> - 1.8.4-9
- Remove the p4 subpackage (#1056123)

* Tue Jan 21 2014 Ondrej Oprala <ooprala@redhat.com> - 1.8.4-8
- Remove the hg subpackage (#1050164)

* Tue Jan 21 2014 Ondrej Oprala <ooprala@redhat.com> - 1.8.4-7
- Remove the bzr subpackage (#1050168)

* Thu Jan 09 2014 Ondrej Oprala <ooprala@redhat.com> - 1.8.4-6
- Supply an older version of a bzr helper script (#1050168)

* Tue Nov 05 2013 Ondrej Oprala <ooprala@redhat.com> - 1.8.4-5
- Rename the appropriate files sections as well

* Tue Nov 05 2013 Ondrej Oprala <ooprala@redhat.com> - 1.8.4-4
- Add missing scl macros to requirements
